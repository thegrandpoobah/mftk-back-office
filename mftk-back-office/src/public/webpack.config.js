...
module.exports = {
    entry: {
        app: "./scripts/main.js",
        vendor: ["jquery", "lodash", "aviator", "handlebars/runtime", "alpaca/dist/alpaca/bootstrap/alpaca", "moment", "modernizr", "bootstrap-switch"],
    ...
    module: {
        loaders: [
            ...
            { test: require.resolve('alpaca/dist/alpaca/bootstrap/alpaca'), loader: 'script!imports?this=>{umd:false%2CjQuery:jQuery%2CHandlebars:Handlebars}' },
